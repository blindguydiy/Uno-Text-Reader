...
class fourDigits extends StatefulWidget {
  final String imagePath;

  fourDigits({required this.imagePath});

  @override
  _fourDigitsState createState() => _fourDigitsState();
}

class _fourDigitsState extends State<fourDigits> {
